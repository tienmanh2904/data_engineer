...
const Page = async ({ params }: PageProps) => {
  ...
  const channel = {
    ...
    serverId: channelRow.server_id.toString(),
    profileId: channelRow.profile_id.toString(),
  ...
  const member = {
    ...
    role: memberRow.role,
    profileId: memberRow.profile_id.toString(),
    serverId: memberRow.server_id.toString(),
